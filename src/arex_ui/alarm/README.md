...
| 文件 | 作用 |
|---|---|
| `alarm.h` | 告警 ID、告警级别、display 结构和对外查询接口。 |
| `alarm.c` | 告警定义表、active 状态表、优先级选择、轮播、ACK 和清除规则。 |
| `alarm_view.h` | 告警视图渲染需要的 screen context。 |
| `alarm_view.c` | safe zone 横幅、L1/L2/L3 节拍、靶向组件闪烁和样式恢复。 |
