...
- TCP 指令支持 `video <1|2|3|4|stop>` / `demo <1|2|3|4|stop>` 启动 15 秒录屏脚本；当前 `video 1` 模拟 8.3m→8.5m→8.2m 和 NDL 70，`video 2` 固定 13m、潜水时间 28:04 起每秒递增、指南针 271°→280°，`3/4` 预留给后续曲线。
