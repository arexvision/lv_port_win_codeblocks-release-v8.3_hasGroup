...
- TCP 指令支持 `video <1|2|3|4|stop>` / `demo <1|2|3|4|stop>` 启动录屏脚本；当前 `video 1` 为 15 秒，模拟 8.3m→8.5m→8.2m 和 NDL 70；`video 2` 为 17 秒，固定 27m、潜水时间 28:04 起每秒递增、指南针 273° 缓慢偏到 258°，`3/4` 预留给后续曲线。
