...
void sys_config_defaults(sys_config_t *cfg)
{
    ...
    static const grid_widget_t module_cards[][MAX_5F_WIDGETS] =
    {
        ...
        },
        {
            ...
            { COMP_ASCENT_1612, 0, 2 }, { COMP_STOP_DEPTH_1612, 2, 2 },
            { COMP_STOP_TIME_1612, 0, 4 }, { COMP_NDL_STOP_1612, 2, 4 },
        },
        {
            { COMP_GF99_1612, 0, 0 }, { COMP_CNS_1612, 2, 0 },
            { COMP_GF_1612, 0, 2 }, { COMP_CEILING_1612, 2, 2 },
        },
        {
    ...
    cfg->altitude_level = 0;  /* 默认 0-300m/0-980ft */
