...
typedef struct
{
    ...
    bool             in_stop_zone;
    uint16_t tts;
    uint16_t tts_at_5min_min;
    int16_t  tts_delta_5min_min;
    int16_t  ndl_up_3m_min;
    int16_t  ndl_down_3m_min;
    int16_t  ndl_delta_3m_min;
    uint16_t gtr_min;
    float    rmv_lpm;
    bool     tts_at_5min_valid;
    bool     tts_delta_5min_valid;
    bool     ndl_up_3m_valid;
    bool     ndl_down_3m_valid;
    bool     ndl_delta_3m_valid;
    bool     gtr_valid;
    bool     rmv_valid;
    bool     sac_valid;
