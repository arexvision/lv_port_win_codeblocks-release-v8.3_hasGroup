 ...
 * - Run "ui_monkey speed 50" to change the injection period at runtime.
...
#define UI_LVGL_MONKEY_INJECT_PERIOD_MS 50U
#define UI_LVGL_MONKEY_INJECT_PERIOD_MIN_MS 15U
#define UI_LVGL_MONKEY_INJECT_PERIOD_MAX_MS 1000U
#define UI_LVGL_MONKEY_MONITOR_PERIOD_MS 2000U
#define UI_LVGL_MONKEY_BLIND_WINDOW_MS 100U
#define UI_LVGL_MONKEY_WIDE_ACTION_INTERVAL 12U
...
#define UI_LVGL_MONKEY_TIMER_STALL_GRACE_MS 500U
#define UI_LVGL_MONKEY_ACTION_COST_WARN_MS 80U
...
#if UI_LVGL_MONKEY_INJECT_PERIOD_MIN_MS < 1U
#error "UI_LVGL_MONKEY_INJECT_PERIOD_MIN_MS must be at least 1"
#endif

#if UI_LVGL_MONKEY_INJECT_PERIOD_MAX_MS < UI_LVGL_MONKEY_INJECT_PERIOD_MIN_MS
#error "UI_LVGL_MONKEY_INJECT_PERIOD_MAX_MS must be >= UI_LVGL_MONKEY_INJECT_PERIOD_MIN_MS"
#endif

#if (UI_LVGL_MONKEY_INJECT_PERIOD_MS < UI_LVGL_MONKEY_INJECT_PERIOD_MIN_MS) || \
    (UI_LVGL_MONKEY_INJECT_PERIOD_MS > UI_LVGL_MONKEY_INJECT_PERIOD_MAX_MS)
#error "UI_LVGL_MONKEY_INJECT_PERIOD_MS must be within min/max range"
#endif
...
#if UI_LVGL_MONKEY_TIMER_STALL_GRACE_MS < 1U
#error "UI_LVGL_MONKEY_TIMER_STALL_GRACE_MS must be at least 1"
#endif
